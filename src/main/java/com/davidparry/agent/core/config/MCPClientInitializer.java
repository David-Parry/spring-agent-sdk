...
import com.davidparry.agent.core.config.client.McpClientManager;
import com.davidparry.agent.core.config.client.ToolRegistry;
import com.davidparry.agent.core.mcp.*;
