...
package com.davidparry.agent.core.config.autoconfigure;
 ...
 * with names based on the prefix (e.g., "messaging-com.davidparry.agent.core.config.MessagingProperties").
            ...
            for (String beanName : beanNames) {
                try {
                    ...
                    if (beanClassName != null && 
                        beanClassName.startsWith("com.davidparry.agent.core.config.") &&
